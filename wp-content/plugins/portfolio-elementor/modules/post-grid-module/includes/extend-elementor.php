...
class PWGD_Register_PwrGrids_Elementor {
	...
	private function add_actions() {
		...
		add_action( 'elementor/frontend/before_register_scripts', function() {			
			...
			wp_enqueue_script( 'jquery-isotope', plugin_dir_url( __FILE__ ) . '../vendor/isotope/js/isotope.pkgd.min.js', array('jquery', 'imagesloaded'), '2.0.1', true );
		...
		add_action( 'elementor/editor/before_enqueue_scripts', function() {			
			wp_enqueue_script( 'jquery-isotope', plugin_dir_url( __FILE__ ) . '../vendor/isotope/js/isotope.pkgd.min.js', array('jquery', 'imagesloaded'), '20151215', true );
